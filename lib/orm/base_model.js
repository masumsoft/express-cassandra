        ...
        validation_wrapper = function(setter, validation_func, prop_name, fieldtype){
            return function(value){
                ...
                if( validation_result !== true )
                    self._validation_errors[prop_name] = build_error('model.set.invalidvalue', validation_result(value, prop_name, fieldtype));
                else
                    delete self._validation_errors[prop_name];
                setter(value);
            };
        },
...
BaseModel.prototype.save = function(options, callback){
    ...
    if(Object.keys(this._validation_errors).length > 0) {
        var validation_error = this._validation_errors[Object.keys(this._validation_errors)[0]];
