...
/**
 * Generate a query to create materialized views for this model
 * @param  {string} table_name Model table name
 * @param  {string} view_name the view name
 * @param  {object} view_schema Schema of the view
 * @return {string} The creation query
 * @protected
 */
                        ...
                        for(var token_rk in token_rel_keys) {
                            ...
                            if(token_first_value instanceof Array) {
                                ...
                                for(var token_index=0;token_index<token_first_value.length;token_index++) {
                                    ...
                                    token_first_value[token_index] = this._get_db_value_expression(token_k[token_index], token_first_value[token_index]);
                                }
...
/**
 * Drop materialized views related to this model
