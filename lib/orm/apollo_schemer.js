...
var schemer = {
    ...
    normalize_model_schema: function(model_schema){
        ...
        var good_fields = {fields : true, key:true, clustering_order:true, indexes:true, custom_index: true};
        ...
        for(k in output_schema.fields){
            if (typeof (output_schema.fields[k]) == 'string' )
                ...
                if(output_schema.fields[k]) {
                    ...
                    throw("output_schema.fields['" + k + "'] not available: " + output_schema.fields[k]);
                }
            }
